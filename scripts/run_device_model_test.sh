...
device_command_string+="./llama-completion $_extra_args -m '$_device_model_path/${_model_name}' --fit on -no-cnv -s 1234 -c 4096 -p '$_prompt_string'"
